...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Order-Direct-Support".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["kantoor.order-direct.nl"];
pub const RS_PUB_KEY: &str = "h5rEy3FW6cIQ72B8EEPgK7IkcLJy6i6M7OEsISWDIBQ=";
